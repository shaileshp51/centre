#ifndef INC_CENTRE_CONSTANTS_H
#define INC_CENTRE_CONSTANTS_H
/*! \file Constants.h
...
const double DEGRAD = 0.017453292519943295; // Pi/180.0 may have precision loss
const double RADDEG = 57.29577951308232;  // 180.0/Pi may have precision loss
...
const double DEFAULT_BAT_VALUE = 1000.0;
}
#endif
