...
void printUsage() {
    ...
    cout << "    -s  --sample     print a sample input file with description of parameters and exit"
         << endl;
    cout << "    -c  --cite       print citation details and exit" << endl;
    cout << "    -O               overwite any already existing files in output directory"
            << endl;
}
...
void printFooter() {
    cout << endl << endl
            << "To cite CENTRE use:                                                                   "
            << endl
            << "Shailesh K. Panday and Indira Ghosh, \"Application and Comprehensive Analysis of " 
            << endl
            << "  Neighbor Approximated Information Theoretic Configurational Entropy Methods to " 
            << endl 
            << "  Protein–Ligand Binding Cases\". J. Chem. Theory Comput. 2020, 16, 12, 7581–7600."
            << endl
            << "                                                                  "
            << endl;
}
